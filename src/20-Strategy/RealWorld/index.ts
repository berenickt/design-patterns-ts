...
interface UploadStrategy {
  upload(filePath: string, name: string, content: string): Promise<UploadResult>
}
...
class LocalUpload implements UploadStrategy {
   ...
   */
  public upload(filePath: string, name: string, content: string): Promise<UploadResult> {
...
class Context {
   ...
   */
  public fileUpload(filePath: string, name: string, content: string): Promise<UploadResult> {
