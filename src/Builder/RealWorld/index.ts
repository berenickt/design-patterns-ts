...
export class User {
  ...
  public setAddress(streetName: string, number: number, city: string, zipCode: string, country: string) {
...
const user3 = userBuilder.setEmail('hugo.first@gmail.com').setIsAdmin().getProduct()
