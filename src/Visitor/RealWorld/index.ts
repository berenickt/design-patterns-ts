...
/**
 * The Visitor Interface declares a visiting method for each product. This way
 * the visitor knows the product type.
 */
interface Visitor {
 ...
 * product set.
 */
function calculateCosts(products: VisitableComponent[], visitor: Visitor): number {
